...
class FreeChildGuest: Entrant {
    init(firstName: String?, birthdate: String) {
        super.init()
        self.firstName = firstName
        self.birthdate = birthdate
    }
...
class Employee: Entrant {
    ...
    init(firstName: String, lastName: String, streetAddress: String, city: String, state: String, zipCode: String, employeeType: PersonOfType) {
